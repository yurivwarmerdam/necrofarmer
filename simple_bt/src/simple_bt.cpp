...
// SleeperC::SleeperC(py::function py_sleeper)
SleeperC::SleeperC(const std::string &name, const NodeConfig &config, py::function py_sleeper) : StatefulActionNode(name, config), py_sleeper(py_sleeper)
{
  // this->py_sleeper = py_sleeper;
}
...
BT::PortsList SleeperC::providedPorts()
{
  return {};
}