...
class ImageServer:
    def __init__(self) -> None:
        ...
        self.animations["tardigrade_4"] = AnimationSequence(
        ...
        self.tardigrade_sprites = sheet_to_sprites(
            load_image("art/simple_thopter.png"), Vector2(64, 64)
        )
        self.animations["thopter_0"] = AnimationSequence(
            self.tardigrade_sprites[(0, 0)],
            self.tardigrade_sprites[(1, 0)],
            self.tardigrade_sprites[(2, 0)],
            self.tardigrade_sprites[(3, 0)],
